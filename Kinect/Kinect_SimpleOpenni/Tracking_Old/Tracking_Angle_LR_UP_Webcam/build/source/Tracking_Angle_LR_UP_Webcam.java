...
public class Tracking_Angle_LR_UP_Webcam extends PApplet {
  ...
  public void draw() {
    ...
    if ( kinect.isTrackingSkeleton(userId)) {
      ...
      if (RightelbowAngle >= 50){
        ...
        if (LeftelbowAngle >= 50){                           //if we clicked in the window
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Tracking_Angle_LR_UP_Webcam" };
    if (passedArgs != null) {
